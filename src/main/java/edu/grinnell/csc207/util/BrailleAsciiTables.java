...
public class BrailleAsciiTables {
  ...
  /**
   * The tree for ASCII to Braille.
   */
  static BitTree a2bTree = null;

  /**
   * The tree for Braille to ASCII.
   */
  static BitTree b2aTree = null;

  /**
   * The tree for Braille to Unicode.
   */
  ...
  /**
   * Converts an Ascii char to binary that matchs its int value.
   *
   * @param c the value to convert.
   *
   * @return the string of converted bits.
   */
  public static String charToAscii(char c) {
    int intRep = (int) c;
    StringBuilder toReturn = new StringBuilder();
    for (int i = 7; i >= 0; i--) {
      if ((intRep - Math.pow(2, i)) >= 0) {
        toReturn.append("1");
        intRep -= Math.pow(2, i);
      } else {
        toReturn.append("0");
  ...
  /**
   * Converts a letter to braille.
   *
   * @param letter the letter to convert to braille.
   * @return the letter converted to braille.
   */
  public static String toBraille(char letter) {
    ...
    return a2bTree.get(charToAscii(letter));
  } // toBraille(char)

  /**
   * Convert bits to ascii.
   *
   * @param bits the bits to convert to Unicode.
   * @return the string of the converted bits.
   */
